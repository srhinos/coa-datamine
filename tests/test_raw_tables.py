...
assert attrs.is_file() and "raw/tables/** -text" in attrs.read_text(encoding="utf-8")
print("[4] line endings: LF everywhere, and .gitattributes stops git rewriting them")
