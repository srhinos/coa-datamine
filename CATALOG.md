...
| `raw/_catalog/joins.json` | 1917 columns with 13800 candidate joins, each with the target's id density and a chance baseline |
...
Sorted by name. `size` is stored bytes; `key` is the f0 id space (distinct ids, and the share of its min..max range they occupy). `text columns` are the string columns with the most distinct values, one real value each.

| table | rows | cols | size | key | shards | text columns |
| --- | ---: | ---: | ---: | --- | --- | --- |
| **Achievement** | 22,618 | 62 | 650.6 KB | 22,618 @ 7% | `raw/tables/Achievement/*.jsonl.gz` | `f4` "No Threat" · `f21` Complete the "Hardcore - Artisan's Guild" cha… · `f43` Felforged Tome: Bounty I |
| **Achievement_Category** | 245 | 20 | 49.9 KB | 245 @ 0.31% | `raw/tables/Achievement_Category/*.jsonl` | `f2` A.B.Y.S.S. |
| **Achievement_Criteria** | 33,630 | 31 | 612.7 KB | 33,630 @ 11% | `raw/tables/Achievement_Criteria/*.jsonl.gz` | `f9` Band of the Earthshatterer |
| **AchievementRewards** | 1,663 | 4 | 65.0 KB | 1,663 @ 1.1% | `raw/tables/AchievementRewards/*.jsonl` | - |
...
| **AppearanceDetails** | 17,297 | 21 | 107.9 KB | 17,297 @ 1.4% | `raw/tables/AppearanceDetails/*.jsonl.gz` | - |
| **Appearances** | 42,884 | 17 | 580.0 KB | 42,884 @ 6.7% | `raw/tables/Appearances/*.jsonl.gz` | `f2` APPEARANCE_DISPLAY_TYPE_ANIMATED_SPELL_VISUAL |
| **AreaGroup** | 304 | 8 | 19.5 KB | 304 @ 6.1% | `raw/tables/AreaGroup/*.jsonl` | - |
| **AreaPOI** | 847 | 54 | 457.4 KB | 847 @ 29% | `raw/tables/AreaPOI/*.jsonl` | `f18` Aerie Peak · `f35` Abyssal Shelf to Kil'Jaeden |
| **AreaTable** | 2,848 | 36 | 1.0 MB | 2,848 @ 19% | `raw/tables/AreaTable/*.jsonl` | `f11` 7th Legion Front |
...
| **ChallengeRewards** | 21,677 | 11 | 185.8 KB | 21,677 @ 35% | `raw/tables/ChallengeRewards/*.jsonl.gz` | `f5` CLASS_BARBARIAN · `f4` EXPANSION_CLASSIC |
...
| **CharacterAdvancement** | 7,820 | 173 | 557.0 KB | 7,820 @ 5.7% | `raw/tables/CharacterAdvancement/*.jsonl.gz` | `f47` "Stealth" · `f64` 5_archerskill02_Border · `f16` Epic |
...
| **CharacterCreationClassGuideSubroleClasses** | 29 | 4 | 966 B | 29 @ 0.48% | `raw/tables/CharacterCreationClassGuideSubroleClasses/*.jsonl` | - |
...
| **CharSections** | 42,354 | 10 | 628.0 KB | 42,354 @ 64% | `raw/tables/CharSections/*.jsonl.gz` | `f4` Character\\BloodElf\\Female\\BloodElfFemaleFaceL… · `f5` Character\\BloodElf\\Female\\BloodElfFemaleFaceU… · `f6` Character\\Draenei2\\ScalpUpperHair00_09.blp |
...
| **ChatProfanity** | 5,233 | 3 | 260.1 KB | 5,233 @ 42% | `raw/tables/ChatProfanity/*.jsonl` | `f1` (五)Ｓ Ｆ |
...
| **Creature** | 127,178 | 23 | 2.8 MB | 127,178 @ 100% | `raw/tables/Creature/*.jsonl.gz` | `f2` Avion de Combate F-80 |
| **CreatureDisplayInfo** | 84,477 | 16 | 977.6 KB | 84,477 @ 8.6% | `raw/tables/CreatureDisplayInfo/*.jsonl.gz` | `f6` CamelMount_white · `f7` 18891 · `f8` ClockworkGnomeFeat_Dark |
| **CreatureDisplayInfoExtra** | 23,351 | 21 | 905.1 KB | 23,351 @ 2.8% | `raw/tables/CreatureDisplayInfoExtra/*.jsonl.gz` | `f20` 2bc78dd036d94c40cb2091c6a66c9a79.blp |
| **CreatureDisplayInfoGeosetData** | 18,935 | 4 | 727.4 KB | 18,935 @ 94% | `raw/tables/CreatureDisplayInfoGeosetData/*.jsonl` | - |
...
| **CreatureModelData** | 35,494 | 28 | 938.1 KB | 35,494 @ 3.9% | `raw/tables/CreatureModelData/*.jsonl.gz` | `f2` Creature\\IronDwarf\\IronDwarf.mdx |
| **CreatureMovementInfo** | 258 | 2 | 5.1 KB | 258 @ 26% | `raw/tables/CreatureMovementInfo/*.jsonl` | - |
| **CreatureSoundData** | 10,398 | 38 | 248.9 KB | 10,398 @ 2.1% | `raw/tables/CreatureSoundData/*.jsonl.gz` | - |
...
| **DeclinedWord** | 29,426 | 2 | 476.3 KB | 29,426 @ 89% | `raw/tables/DeclinedWord/*.jsonl.gz` | `f1` """Безумный"" Иона Стерлинг" |
| **DeclinedWordCases** | 141,956 | 4 | 2.8 MB | 141,956 @ 97% | `raw/tables/DeclinedWordCases/*.jsonl.gz` | `f3` """"Красавчика"" Дункана" |
| **DestructibleModelData** | 41 | 19 | 6.1 KB | 41 @ 95% | `raw/tables/DestructibleModelData/*.jsonl` | - |
| **DungeonEncounter** | 2,080 | 23 | 450.5 KB | 2,080 @ 5.6% | `raw/tables/DungeonEncounter/*.jsonl` | `f5` Admiral Seastomper |
| **DungeonEncounterExtra** | 2,080 | 4 | 81.0 KB | 2,048 @ 5.5% | `raw/tables/DungeonEncounterExtra/*.jsonl` | - |
...
| **EnchantEnchantSuggestions** | 380,008 | 4 | 2.6 MB | 380,008 @ 100% | `raw/tables/EnchantEnchantSuggestions/*.jsonl.gz` | - |
...
| **FileData** | 13 | 3 | 1.1 KB | 13 @ 0.0036% | `raw/tables/FileData/*.jsonl` | `f1` LOGO_1024.AVI · `f2` INTERFACE\\CINEMATICS\\ |
...
| **GameObjectDisplayInfo** | 120,869 | 19 | 1.7 MB | 120,869 @ 11% | `raw/tables/GameObjectDisplayInfo/*.jsonl.gz` | `f1` ITEM\\OBJECTCOMPONENTS\\HEAD\\Helm_Leather_RaidR… |
| **GameObjectDisplayInfoAddon** | 106,834 | 2 | 532.2 KB | 106,834 @ 10% | `raw/tables/GameObjectDisplayInfoAddon/*.jsonl.gz` | `f1` ITEM\\OBJECTCOMPONENTS\\HEAD\\Helm_Robe_DungeonR… |
...
| **GlobalStrings** | 14,344 | 20 | 465.7 KB | 14,344 @ 89% | `raw/tables/GlobalStrings/*.jsonl.gz` | `f2` ABANDON_PET · `f3` %s has left the raid group. |
...
| **GroundEffectDoodad** | 1,968 | 3 | 103.3 KB | 1,968 @ 33% | `raw/tables/GroundEffectDoodad/*.jsonl` | `f1` 10nrbmoss01.mdl |
| **GroundEffectTexture** | 38,436 | 11 | 211.2 KB | 38,436 @ 22% | `raw/tables/GroundEffectTexture/*.jsonl.gz` | - |
...
| **HDCharSections** | 25,544 | 10 | 406.0 KB | 25,544 @ 39% | `raw/tables/HDCharSections/*.jsonl.gz` | `f5` Character\\BloodElf\\Female\\BloodElfFemaleFaceU… · `f4` Character\\BloodElf\\Female\\BloodElfFemaleFaceL… · `f6` Character\\Draenei\\ScalpUpperHair00_04.blp |
| **HDCreatureDisplayInfo** | 6,855 | 16 | 80.6 KB | 6,855 @ 0.73% | `raw/tables/HDCreatureDisplayInfo/*.jsonl.gz` | `f6` DragonSkin1Blue · `f7` Copper · `f8` DRAKESKINGREEN3 |
| **HDCreatureDisplayInfoExtra** | 14,169 | 21 | 425.0 KB | 14,169 @ 2.8% | `raw/tables/HDCreatureDisplayInfoExtra/*.jsonl.gz` | `f20` CreatureDisplayExtra-00023_HD.blp |
| **HDCreatureModelData** | 545 | 28 | 225.8 KB | 545 @ 0.054% | `raw/tables/HDCreatureModelData/*.jsonl` | `f2` CHARACTER\\Naga_\\Female\\Naga_Female.mdx |
...
| **Item** | 563,335 | 8 | 2.8 MB | 563,335 @ 6.1% | `raw/tables/Item/*.jsonl.gz` | - |
| **ItemAddon** | 563,335 | 48 | 11.6 MB | 563,335 @ 100% | `raw/tables/ItemAddon/*.jsonl.gz` | `f2` (Backsheath) · `f19` @Mythic 19@Glows with the power of magiskull. |
| **ItemAppearances** | 202,903 | 3 | 1.2 MB | 202,903 @ 31% | `raw/tables/ItemAppearances/*.jsonl.gz` | - |
...
| **ItemDisplayInfo** | 129,603 | 25 | 3.6 MB | 129,603 @ 76% | `raw/tables/ItemDisplayInfo/*.jsonl.gz` | `f5` Asc_LuckyCard_gold_Retribution_Aura · `f3` Cape_Mail_D_02IllidanRed · `f16` LEATHER_NORTHREND_C_01_SLEEVE_AL |
...
| **ItemExtendedCost** | 13,777 | 16 | 82.3 KB | 13,777 @ 21% | `raw/tables/ItemExtendedCost/*.jsonl.gz` | - |
...
| **ItemSet** | 2,347 | 53 | 101.3 KB | 2,347 @ 3.7% | `raw/tables/ItemSet/*.jsonl.gz` | `f1` Garments of Malevolent Possession |
| **ItemSetAppearances** | 1,603 | 3 | 52.7 KB | 1,603 @ 1.2% | `raw/tables/ItemSetAppearances/*.jsonl` | - |
| **ItemSpells** | 131,722 | 37 | 1.0 MB | 131,722 @ 100% | `raw/tables/ItemSpells/*.jsonl.gz` | - |
| **ItemStat** | 1,513,931 | 39 | 23.9 MB | 1,513,931 @ 95% | `raw/tables/ItemStat/*.jsonl.gz` | - |
...
| **ItemVisuals** | 227 | 6 | 12.2 KB | 227 @ 3.2% | `raw/tables/ItemVisuals/*.jsonl` | - |
...
| **Light** | 1,349 | 15 | 220.9 KB | 1,349 @ 1.3% | `raw/tables/Light/*.jsonl` | - |
| **LightFloatBand** | 6,834 | 34 | 59.1 KB | 6,834 @ 11% | `raw/tables/LightFloatBand/*.jsonl.gz` | - |
| **LightIntBand** | 20,503 | 34 | 273.9 KB | 20,503 @ 11% | `raw/tables/LightIntBand/*.jsonl.gz` | - |
| **LightParams** | 1,140 | 9 | 102.6 KB | 1,140 @ 11% | `raw/tables/LightParams/*.jsonl` | - |
| **LightSkybox** | 230 | 3 | 18.4 KB | 230 @ 1.5% | `raw/tables/LightSkybox/*.jsonl` | `f1` ENVIRONMENTS\\Stars\\Vendetta_Machinima.mdx |
...
| **ManastormModifiers** | 32,768 | 15 | 936.6 KB | 32,768 @ 100% | `raw/tables/ManastormModifiers/*.jsonl.gz` | - |
| **ManastormPlayerGroupModifiers** | 15 | 5 | 1.0 KB | 15 @ 100% | `raw/tables/ManastormPlayerGroupModifiers/*.jsonl` | - |
| **Map** | 374 | 66 | 265.0 KB | 374 @ 9.3% | `raw/tables/Map/*.jsonl` | `f1` ABWinter · `f5` 5ppl_snow_bg · `f23` A valley bordering Ashenvale Forest and the B… |
...
| **MovieFileData** | 12 | 2 | 268 B | 12 @ 0.0034% | `raw/tables/MovieFileData/*.jsonl` | - |
| **MovieVariation** | 13 | 3 | 363 B | 13 @ 12% | `raw/tables/MovieVariation/*.jsonl` | - |
| **MysticEnchant** | 7,815 | 31 | 91.0 KB | 7,815 @ 0.45% | `raw/tables/MysticEnchant/*.jsonl.gz` | `f15` AFFLICTION · `f16` ARMS · `f3` RE_QUALITY_ARTIFACT |
| **MythicAffixes** | 13,409 | 16 | 75.3 KB | 13,409 @ 100% | `raw/tables/MythicAffixes/*.jsonl.gz` | - |
...
| **NamesReserved** | 16,329 | 3 | 849.1 KB | 16,329 @ 53% | `raw/tables/NamesReserved/*.jsonl` | `f1` 18? |
| **NPCSounds** | 2,487 | 5 | 127.8 KB | 2,487 @ 0.5% | `raw/tables/NPCSounds/*.jsonl` | - |
| **NPCTrainer** | 13,111 | 4 | 519.1 KB | 13,111 @ 100% | `raw/tables/NPCTrainer/*.jsonl` | - |
...
| **Quest** | 18,561 | 29 | 142.3 KB | 18,561 @ 0.23% | `raw/tables/Quest/*.jsonl.gz` | - |
...
| **QuestSuperTrack** | 11,269 | 102 | 154.2 KB | 11,269 @ 34% | `raw/tables/QuestSuperTrack/*.jsonl.gz` | - |
| **QuestTemplateScaling** | 5,535 | 15 | 687.2 KB | 5,535 @ 0.33% | `raw/tables/QuestTemplateScaling/*.jsonl` | - |
...
| **ScreenEffect** | 52 | 10 | 6.1 KB | 52 @ 0.52% | `raw/tables/ScreenEffect/*.jsonl` | `f1` Arthas Memory Events |
...
| **SkillLine** | 872 | 56 | 493.8 KB | 872 @ 7.4% | `raw/tables/SkillLine/*.jsonl` | `f3` !Ascension Manastorm Items · `f20` Armed with an axe, Woodcutters embark on a tr… · `f38` Emboss |
| **SkillLineAbility** | 38,542 | 14 | 265.3 KB | 38,542 @ 0.96% | `raw/tables/SkillLineAbility/*.jsonl.gz` | - |
...
| **SoundEntries** | 45,868 | 30 | 2.2 MB | 45,868 @ 11% | `raw/tables/SoundEntries/*.jsonl.gz` | `f2` A_HELL_Legion01_Reinf02 · `f3` CAV_Chrono_Banish01.wav · `f4` DrakeadonWoundB.wav |
| **SoundEntriesAdvanced** | 18,810 | 24 | 146.9 KB | 18,810 @ 9.7% | `raw/tables/SoundEntriesAdvanced/*.jsonl.gz` | `f23` AC_BlackKnight_Aggro01 |
...
| **Spell** | 238,939 | 234 | 21.4 MB | 238,939 @ 1.7% | `raw/tables/Spell/*.jsonl.gz` | `f136` AB: Blackrock Depths (D1) (PHYS) (HP) · `f170` <Right click to apply this enchant to a piece… · `f187` A Knight of Decay is granting you $s2% increa… |
...
| **SpellAddon** | 5,602 | 23 | 1.0 MB | 5,602 @ 0.35% | `raw/tables/SpellAddon/*.jsonl` | - |
| **SpellAffect** | 36,779 | 3 | 205.0 KB | 36,779 @ 0.4% | `raw/tables/SpellAffect/*.jsonl.gz` | - |
...
| **SpellCategory** | 5,189 | 2 | 97.5 KB | 5,189 @ 63% | `raw/tables/SpellCategory/*.jsonl` | - |
| **SpellChainEffects** | 6,636 | 45 | 338.1 KB | 6,636 @ 0.66% | `raw/tables/SpellChainEffects/*.jsonl.gz` | `f7` SPELLS\\TEXTURES\\Beam_SmokeGrey.blp |
...
| **SpellCustomAttr** | 58,583 | 11 | 375.7 KB | 58,583 @ 100% | `raw/tables/SpellCustomAttr/*.jsonl.gz` | - |
...
| **SpellEnchantSuggestions** | 1,144,863 | 4 | 6.5 MB | 1,144,863 @ 100% | `raw/tables/SpellEnchantSuggestions/*.jsonl.gz` | - |
| **SpellFocusObject** | 435 | 18 | 77.9 KB | 435 @ 25% | `raw/tables/SpellFocusObject/*.jsonl` | `f1` Aerie Peak Town Center |
| **SpellIcon** | 16,361 | 2 | 218.7 KB | 16,361 @ 1.7% | `raw/tables/SpellIcon/*.jsonl.gz` | `f1` INTERFACE\\ICONS\\ability_mount_celestialhorse |
| **SpellItemEnchantment** | 18,035 | 38 | 261.4 KB | 18,035 @ 1.5% | `raw/tables/SpellItemEnchantment/*.jsonl.gz` | `f14` +10 Dodge Rating |
...
| **SpellRank** | 19,601 | 4 | 847.9 KB | 19,601 @ 100% | `raw/tables/SpellRank/*.jsonl` | - |
| **SpellRoleSuggestions** | 0 | 4 | 0 B | - | `raw/tables/SpellRoleSuggestions/*.jsonl` | - |
| **SpellRuneCost** | 476 | 5 | 19.2 KB | 476 @ 19% | `raw/tables/SpellRuneCost/*.jsonl` | - |
| **SpellShapeshiftForm** | 61 | 35 | 19.0 KB | 61 @ 97% | `raw/tables/SpellShapeshiftForm/*.jsonl` | `f2` Aquatic Form |
| **SpellSpellSuggestions** | 353,193 | 4 | 2.3 MB | 353,193 @ 100% | `raw/tables/SpellSpellSuggestions/*.jsonl.gz` | - |
| **SpellStatSuggestions** | 1,121 | 4 | 40.2 KB | 1,121 @ 100% | `raw/tables/SpellStatSuggestions/*.jsonl` | - |
| **SpellTags** | 488,662 | 3 | 2.6 MB | 488,662 @ 86% | `raw/tables/SpellTags/*.jsonl.gz` | - |
...
| **SpellVisual** | 23,104 | 32 | 282.4 KB | 23,104 @ 2.2% | `raw/tables/SpellVisual/*.jsonl.gz` | - |
| **SpellVisualEffectName** | 18,700 | 7 | 520.4 KB | 18,700 @ 0.54% | `raw/tables/SpellVisualEffectName/*.jsonl.gz` | `f1` 7fx_eonar_rainoffel_precast · `f2` SPELLS/cfx_mage_fireprecast_precastbase.m2 |
| **SpellVisualKit** | 29,541 | 38 | 411.5 KB | 29,541 @ 0.85% | `raw/tables/SpellVisualKit/*.jsonl.gz` | - |
| **SpellVisualKitAreaModel** | 17 | 3 | 1.1 KB | 17 @ 0.2% | `raw/tables/SpellVisualKitAreaModel/*.jsonl` | `f1` Spells\\ArcaneShot_Area.mdx |
| **SpellVisualKitModelAttach** | 7,867 | 10 | 825.0 KB | 7,867 @ 0.98% | `raw/tables/SpellVisualKitModelAttach/*.jsonl` | - |
...
| **SuperTrack** | 9,763 | 8 | 217.6 KB | 9,763 @ 45% | `raw/tables/SuperTrack/*.jsonl.gz` | - |
| **Talent** | 2,368 | 23 | 458.7 KB | 2,368 @ 2.1% | `raw/tables/Talent/*.jsonl` | - |
...
| **TaxiPathNode** | 23,314 | 11 | 560.2 KB | 23,314 @ 50% | `raw/tables/TaxiPathNode/*.jsonl.gz` | - |
...
| **VanityCollection** | 10,671 | 77 | 320.6 KB | 10,671 @ 0.096% | `raw/tables/VanityCollection/*.jsonl.gz` | `f42` Available from the Webstore as part of the Sp… · `f3` Ardenwealdstagmount2-teal-Glow-IngameCollecti… · `f59` Available from the Trial Master's Rewards Ven… |
...
| **VehicleSeat** | 1,030 | 58 | 612.8 KB | 1,030 @ 10% | `raw/tables/VehicleSeat/*.jsonl` | - |
...
| **WMOAreaTable** | 24,195 | 28 | 218.0 KB | 24,195 @ 45% | `raw/tables/WMOAreaTable/*.jsonl.gz` | `f11` Bandit Cave |
| **WorldChunkSounds** | 0 | 9 | 0 B | - | `raw/tables/WorldChunkSounds/*.jsonl` | - |
| **WorldMapArea** | 307 | 11 | 44.1 KB | 307 @ 10% | `raw/tables/WorldMapArea/*.jsonl` | `f3` AdtDevMap |
...
| **WorldSafeLocs** | 915 | 22 | 257.7 KB | 915 @ 13% | `raw/tables/WorldSafeLocs/*.jsonl` | `f5` AAA - Arena (Dev Test) |
