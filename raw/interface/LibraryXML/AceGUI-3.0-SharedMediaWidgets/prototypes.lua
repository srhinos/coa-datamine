...
local AGSMW = LibStub:NewAscensionLibrary("AceGUISharedMediaWidgets-1.0", DataVersion)
...
do
	...
	local function AddFrame(self, frame)
		...
		self.contentframe:SetWidth(self.scrollframe:GetWidth()-42)
	end
