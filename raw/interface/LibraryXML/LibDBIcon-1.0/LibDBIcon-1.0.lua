...
local lib = LibStub:NewAscensionLibrary(DBICON10)
...
local function updatePosition(button)
	local angle = math.rad(button.db and button.db.minimapPos or button.minimapPos or button.dataObject.minimapPos or 225)
