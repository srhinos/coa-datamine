	...
	if ( event == "ADDON_LOADED" ) then
		...
		AchievementFrameCategoriesContainerScrollBar.Show = 
			function (self)
				...
				AchievementFrameSummary:SetPoint("TOPLEFT", AchievementFrameCategories, "TOPRIGHT", 22, 0)
		...
		AchievementFrameCategoriesContainerScrollBar.Hide = 
			function (self)
				...
				AchievementFrameSummary:SetPoint("TOPLEFT", AchievementFrameCategories, "TOPRIGHT", 0, 0)
...
function AchievementButton_OnClick (self, ignoreModifiers)
	...
	HybridScrollFrame_ExpandButton(AchievementFrameAchievementsContainer, self.index, self:GetHeight());
	AchievementFrameAchievements_Update();
...
function AchievementFrameComparison_OnEvent (self, event, ...)
	if ( event == "INSPECT_ACHIEVEMENT_READY" ) then
		if achievementFunctions.selectedCategory then
