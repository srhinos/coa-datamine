...
L["Open all Auction pending mail"] = "Öffne alle 'Auktion gewonnen'-Nachrichten"
...
L["Open all Auction pending mail"] = "Abrir todo el correo de Subastas ganadas"
...
L["Open all Auction pending mail"] = "Ouvrir tous les courriers des enchères gagnées"
...
L["Open all Auction pending mail"] = "경매 낙찰된 우편 모두 열기"
...
L["Open all Auction pending mail"] = "Открыть все письма с выигранным товаром"
...
L["Open all Auction pending mail"] = "打开所有赢得拍卖的邮件"
...
L["Open all Auction pending mail"] = "打開所有赢得拍賣的信件"
...
L["Open all Auction pending mail"] = "Abrir todas as cartas de Leilões ganhos"
...
L["Open all Auction pending mail"] = "Apri tutte le lettere di vincita della casa d'aste"
