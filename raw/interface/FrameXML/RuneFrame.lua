...
function RuneFrame_OnLoad (self)
	...
	self:RegisterEvent("ASCENSION_SPELLS_UPDATED")
...
function RuneFrame_OnEvent (self, event, ...)
	if event == "ASCENSION_SPELLS_UPDATED" then
		RuneFrame_CheckShouldShow(self)
...
function RuneFrame_OnShow()
	TotemFrame_Update()
	PetFrame_Update(PetFrame)
end

function RuneFrame_OnHide()
	TotemFrame_Update()
	PetFrame_Update(PetFrame)
end

function RuneFrame_CheckShouldShow(self)
